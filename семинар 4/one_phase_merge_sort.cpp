...
template <typename T> inline void one_phase_merge_sort(const char* file_name, T none) {
	...
	int main_file_length = 0;
	int sub_file_1_length = 0;
	int sub_file_2_length = 0;
	...
	while (counter < main_file_length and main_file_length > 1) {
